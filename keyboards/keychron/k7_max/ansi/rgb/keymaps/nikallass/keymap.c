...
// Global variables to track modifier + ESC states
bool shift_esc_pressed = false;
bool alt_esc_pressed = false;
bool gui_esc_pressed = false;
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    // Process standard Keychron functions (if you're using Keychron keyboard)
